...
public class DijkstraAlgorithmShortestPathBetweenNodes {
    ...
    public static void main(String[] args) {
        ...
        Map<String, String> dijkstraPath = dijkstra(graph, 5, "A", "E");
        List<String> path = pathFromAtoB(dijkstraPath, "E");
        System.out.println(path);

        Map<String, String> dijkstraPath2 = dijkstra(graph, 5, "A", "B");
        List<String> path2 = pathFromAtoB(dijkstraPath2, "B");
    ...
    public static Map<String, String> dijkstra(Map<String, List<Edge<String>>> graph, int numNodes, String start, String end){
        ...
        while (pq.size() != 0){
            ...
            // we are checking whether we are reaching end node early
            if (node.getKey().equals(end)) return prevMap;
