...
public class DijkstraAlgorithmShortestDistanceBetweenNodes {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Integer> dijkstraDistance = dijkstra(graph, 5, "A", "E");
        System.out.println(dijkstraDistance);

        Map<String, Integer> dijkstraDistance2 = dijkstra(graph, 5, "A", "B");
        System.out.println(dijkstraDistance2);

    }

    public static Map<String, Integer> dijkstra(Map<String, List<Edge<String>>> graph, int numNodes, String start, String end){
        ...
        while (pq.size() != 0){
            ...
            if (node.getKey().equals(end)) return distance;
        }
